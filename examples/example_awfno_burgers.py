...
def train_burgers():
    ...
    print(f"Starting AW-FNO 1D training on Burgers for {epochs} epochs...")
    ...
    plt.title('Burgers Relative L2 Loss')
    plt.legend()
