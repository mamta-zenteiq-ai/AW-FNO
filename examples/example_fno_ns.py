...
def train_ns():
    ...
    # 2. Load Data
    print("Loading Navier-Stokes (64x64) data for FNO...")
    ...
    print(f"Starting FNO training on Navier-Stokes for {epochs} epochs...")
    ...
    plt.title('NS FNO Relative L2 Loss')
    plt.legend()
