...
def train_burgers():
    ...
    print(f"Starting WNO 1D training on Burgers for {epochs} epochs...")
    ...
    plt.xlabel('Epoch')
    plt.ylabel('MSE')
    plt.title('WNO Burgers MSE Loss')
    plt.legend()
    ...
    plt.title('WNO Burgers Relative L2 Loss')
    plt.legend()
    
    plt.tight_layout()
    plt.savefig(os.path.join(results_dir, 'wno_burgers_loss_plot.png'))
    print(f"Loss plot saved to {os.path.join(results_dir, 'wno_burgers_loss_plot.png')}")
