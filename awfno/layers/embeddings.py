...
class GridEmbeddingND(nn.Module):
    ...
    grid_boundaries : list, optional
        ...
        """
    def __init__(self, in_channels: int, dim: int=2, grid_boundaries=None):
        super().__init__()
        self.in_channels = in_channels
        self.dim = dim
        ...
        ), f"Error: expected grid_boundaries to be an iterable of length {self.dim}, received {self.grid_boundaries}"
        self._grid = None
        self._res = None
